...
int idr_copy_importance(ay_object *o, unsigned int from_type);
 ...
 */
int
idr_copy_importance(ay_object *o, unsigned int from_type)
{
 int ay_status = AY_OK;
 double dtemp = 0.0;
 ay_object *down = NULL;
